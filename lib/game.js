...
class Game {
    constructor(canvas, ctx){
        ...
        // this.enemies = this.enemy.enemies;
        this.score = 0;
        this.alive = true;
    ...
    draw() {
        ...
        this.enemies.forEach((el) => {
            ...
            if (this.player.playerX > el.enemyX){
                ...
                el.enemyX -= 2;
            } else if (this.player.playerX == el.enemyX && this.player.playerY >= el.enemyY - 5) {
            // } else if (this.player.playerX >= el.enemyX - this.player.playerWidth && this.player.playerY >= el.enemyY + 5
            //     || this.player.playerX <= el.enemyX + this.player.playerWidth && this.player.playerY >= el.enemyY + 5) {
                el.enemySprite = this.enemySpriteRight;
                this.alive = false;
            }
