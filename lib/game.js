...
class Game {
    ...
    drawLives() {
        ...
        this.ctx.strokeText("Lives: " + this.lives, this.canvas.width - 65, 20);
    ...
    drawGame() {
        ...
        this.enemies.forEach((el) => {
            ...
            if (this.player.playerX <= el.enemyX + 28 && this.player.playerX >= el.enemyX - 24 && this.player.playerY >= el.enemyY - 20){
                el.enemySprite = this.enemySpriteRight;
                this.enemies.splice(el);
                this.lives -= 1;
                this.addEnemies();
            }

            if (this.upPressed && (this.playerY > (this.canvas.height - this.playerHeight - 86))) {
                    this.playerY -= 15; 
                }
